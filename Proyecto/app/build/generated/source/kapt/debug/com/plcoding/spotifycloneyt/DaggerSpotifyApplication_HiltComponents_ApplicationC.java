...
import com.plcoding.spotifycloneyt.di.AppModule;
import com.plcoding.spotifycloneyt.di.AppModule_ProvideGlideInstanceFactory;
import com.plcoding.spotifycloneyt.di.AppModule_ProvideMusicServiceConnectionFactory;
import com.plcoding.spotifycloneyt.di.AppModule_ProvideSwipeSongAdapterFactory;
import com.plcoding.spotifycloneyt.di.ServiceModule_ProvideAudioAttributesFactory;
import com.plcoding.spotifycloneyt.di.ServiceModule_ProvideDataSourceFactoryFactory;
import com.plcoding.spotifycloneyt.di.ServiceModule_ProvideExoPlayerFactory;
import com.plcoding.spotifycloneyt.di.ServiceModule_ProvideMusicDatabaseFactory;
...
import com.plcoding.spotifycloneyt.exoplayer.MusicService_MembersInjector;
import com.plcoding.spotifycloneyt.ui.MainActivity;
import com.plcoding.spotifycloneyt.ui.MainActivity_MembersInjector;
import com.plcoding.spotifycloneyt.ui.fragments.HomeFragment;
import com.plcoding.spotifycloneyt.ui.fragments.HomeFragment_MembersInjector;
import com.plcoding.spotifycloneyt.ui.fragments.SongFragment;
import com.plcoding.spotifycloneyt.ui.fragments.SongFragment_MembersInjector;
import com.plcoding.spotifycloneyt.ui.viewmodels.MainViewModel_AssistedFactory;
import com.plcoding.spotifycloneyt.ui.viewmodels.MainViewModel_AssistedFactory_Factory;
import com.plcoding.spotifycloneyt.ui.viewmodels.SongViewModel_AssistedFactory;
import com.plcoding.spotifycloneyt.ui.viewmodels.SongViewModel_AssistedFactory_Factory;
...
public final class DaggerSpotifyApplication_HiltComponents_ApplicationC extends SpotifyApplication_HiltComponents.ApplicationC {
  ...
  private final class ActivityRetainedCImpl extends SpotifyApplication_HiltComponents.ActivityRetainedC {
    ...
    private final class ActivityCImpl extends SpotifyApplication_HiltComponents.ActivityC {
      ...
      private Map<String, Provider<ViewModelAssistedFactory<? extends ViewModel>>> getMapOfStringAndProviderOfViewModelAssistedFactoryOf(
        ...
        return ImmutableMap.<String, Provider<ViewModelAssistedFactory<? extends ViewModel>>>of("com.plcoding.spotifycloneyt.ui.viewmodels.MainViewModel", (Provider) getMainViewModel_AssistedFactoryProvider(), "com.plcoding.spotifycloneyt.ui.viewmodels.SongViewModel", (Provider) getSongViewModel_AssistedFactoryProvider());
      }
      ...
      private final class SwitchingProvider<T> implements Provider<T> {
        ...
        public T get() {
          switch (id) {
            case 0: // com.plcoding.spotifycloneyt.ui.viewmodels.MainViewModel_AssistedFactory 
            return (T) ActivityCImpl.this.getMainViewModel_AssistedFactory();

            case 1: // com.plcoding.spotifycloneyt.ui.viewmodels.SongViewModel_AssistedFactory 
  ...
  private final class SwitchingProvider<T> implements Provider<T> {
    ...
    public T get() {
      switch (id) {
        case 0: // com.plcoding.spotifycloneyt.exoplayer.MusicServiceConnection 

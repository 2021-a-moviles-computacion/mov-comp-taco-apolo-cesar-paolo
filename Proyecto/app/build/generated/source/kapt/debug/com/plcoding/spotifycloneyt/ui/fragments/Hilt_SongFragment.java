...
public abstract class Hilt_SongFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_SongFragment(int contentLayoutId) {
  ...
  protected void inject() {
    ((SongFragment_GeneratedInjector) generatedComponent()).injectSongFragment(UnsafeCasts.<SongFragment>unsafeCast(this));
  }

...
public abstract class BaseSongAdapter extends androidx.recyclerview.widget.RecyclerView.Adapter<com.plcoding.spotifycloneyt.adapters.BaseSongAdapter.SongViewHolder> {
    ...
    private final androidx.recyclerview.widget.DiffUtil.ItemCallback<com.plcoding.spotifycloneyt.data.entities.Song> diffCallback = null;
    @org.jetbrains.annotations.Nullable()
    private kotlin.jvm.functions.Function1<? super com.plcoding.spotifycloneyt.data.entities.Song, kotlin.Unit> onItemClickListener;
    private final int layoutId = 0;
    
    @org.jetbrains.annotations.NotNull()
    protected final androidx.recyclerview.widget.DiffUtil.ItemCallback<com.plcoding.spotifycloneyt.data.entities.Song> getDiffCallback() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    protected abstract androidx.recyclerview.widget.AsyncListDiffer<com.plcoding.spotifycloneyt.data.entities.Song> getDiffer();
    
    @org.jetbrains.annotations.NotNull()
    public final java.util.List<com.plcoding.spotifycloneyt.data.entities.Song> getSongs() {
        return null;
    }
    
    public final void setSongs(@org.jetbrains.annotations.NotNull()
    java.util.List<com.plcoding.spotifycloneyt.data.entities.Song> value) {
    }
    ...
    @org.jetbrains.annotations.Nullable()
    protected final kotlin.jvm.functions.Function1<com.plcoding.spotifycloneyt.data.entities.Song, kotlin.Unit> getOnItemClickListener() {
        return null;
    }
    
    protected final void setOnItemClickListener(@org.jetbrains.annotations.Nullable()
    kotlin.jvm.functions.Function1<? super com.plcoding.spotifycloneyt.data.entities.Song, kotlin.Unit> p0) {
    }
    
    public final void setItemClickListener(@org.jetbrains.annotations.NotNull()
    kotlin.jvm.functions.Function1<? super com.plcoding.spotifycloneyt.data.entities.Song, kotlin.Unit> listener) {
    }
